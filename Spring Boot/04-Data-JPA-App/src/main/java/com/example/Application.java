...
public class Application {
	...
	public static void main(String[] args) {
		...
		System.out.println("********** 14. findByRankLessThanEqual(int rank) **********");
		...
		System.out.println("********** 15. findByGenderAndRankGreaterThanEqual(String gender, int rank) **********");
